<x-app-layout :title="'Rekam Medis'" :subtitle="'Riwayat pemeriksaan dan diagnosis pasien'">
    <div class="bg-white rounded-2xl border border-slate-200">
        <div class="p-5 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between border-b border-slate-100">
            ...
            <a href="{{ route('rekam-medis.create') }}" class="inline-flex items-center justify-center gap-2 bg-teal-600 hover:bg-teal-700 text-white text-sm font-semibold px-4 py-2.5 rounded-xl transition">
                + Tambah Rekam Medis
            </a>
        </div>
